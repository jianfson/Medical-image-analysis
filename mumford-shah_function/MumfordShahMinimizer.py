#!/usr/bin/env python
# coding=utf-8
#Implementation of edge preserving smoothing
#Scheme, using conjugate gradients
import cv2, scipy
import numpy as np
import sys
import scipy
...
if __name__ == "__main__":
	...
	for channel in cv2.split(img):
		solver = MumfordShahMinimizer(channel, iterations = 1, tol = 0.1, solver_maxiterations = 6)
		f, v = solver.minimize()
		result.append(f)
		edges.append(v)
